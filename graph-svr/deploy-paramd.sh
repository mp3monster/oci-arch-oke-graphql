...
docker buildx build --platform linux/amd64 --push -t iad.ocir.io/ociobenablement/graphql-svr:latest .
#docker logout iad.ocir.io/ociobenablement/
kubectl delete deployment graph-svr-deployment
sleep 15
kubectl apply -f ./deployment.yaml
kubectl apply -f ./graph-svr-svc.yaml